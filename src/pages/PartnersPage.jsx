...
const PartnersPage = () => {
  ...
  const testimonials = [
    {
      quote:
        "AxionCloud has been instrumental in growing our gaming community. Their servers are rock-solid.",
      author: "Sarah Chen",
    ...
    {
      quote:
        "The level of support and technical expertise provided by AxionCloud is unmatched in the industry.",
      author: "Mike Wilson",
    ...
    {
      quote:
        "We've seen significant growth since partnering with AxionCloud. Their infrastructure is top-notch.",
      author: "David Park",
      role: "CEO",
      company: "ServerCraft",
    },
  ...
  return (
    <div className="min-h-screen bg-black">
      <Helmet>
        <title>Partners | AxionCloud</title>
      </Helmet>
      {/* Hero Section */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-12">
            <div className="text-center">
              ...
              <p className="text-lg lg:text-xl text-blue-100 max-w-3xl mx-auto mt-4">
                Hear what our partners have to say about working with AxionCloud
              </p>
            </div>
